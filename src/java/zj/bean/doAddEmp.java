 ...
 * @author blocks
 */
public class doAddEmp {
    
    public static boolean doInsert(ServletConfig config,HttpServletRequest request, HttpServletResponse response)throws Exception
    {
        boolean flag=false;
        ...
        while(iter.hasNext())
        {
            ...
            else if(item.getFieldName().equals("photo"))
            {
                ...
                if(saveFile.exists())
                {
                    ...
                    System.out.println("photopath:"+saveDirectory.getName()+fname2+"("+i+")"+fname3);
                }
                else
                {
                    break;
